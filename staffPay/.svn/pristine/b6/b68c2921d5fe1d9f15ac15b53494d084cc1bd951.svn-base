...
import com.chunqiu.mrjuly.common.config.Global;
...
public class GenUtils {
	...
	public static <T> T fileToObject(String fileName, Class<?> clazz){
		try {
			String pathName = "/genTemplates/" + fileName;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("dbType", new Global().getJdbcUrl());
	...
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile){
		...
		//log.info("生成到文件模板============="+tpl);

		//log.info("model信息============"+(GenTable)model.get("table"));
		// 获取生成文件内容
