$(function() {
    ...
    //add by wcf at 2016-07-12
    function m() {
    	 var ss = $(".page-tabs-content .active").eq(0);
    	 var bb = ss.data("id");
    	 $('.J_iframe[data-id="' + ss.data("id") + '"]').attr("src", ss.data("id"));
    }
    $(".J_tabRefreshActive").on("click", m);
    //end add
    ...
    function n() {
        layer.open({
            ...
            title : '修改密码',
            area : ['500px','250px'],
            content: ctx + '/system/user/editPwd', //这里content是一个DOM
            btn : ['保存', '关闭'],
            closeBtn : '1',
