...
import com.chunqiu.mrjuly.common.enums.LimitType;
...
/**
 * 接口限流注解，示例见 chunqiu.mrjuly.common.controller.TestController
 */
@Aspect
@Component
public class LimitAspect{
    ...
    @Pointcut("@annotation(com.chunqiu.mrjuly.common.annotation.Limit)")
