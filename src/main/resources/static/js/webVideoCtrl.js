(function (e) {
    ...
    var t = function () {
      ...
      this.I_GetOSDTime = function (e) {
        ...
        if ( - 1 != t) {
          ...
          return I.dateFormat(new Date(1000 * n), 'yyyy-MM-dd hh:mm:ss')
        }
        return s
      },
  ...
  rt.prototype.browser = function () {
    ...
    i = e.exec(o) || t.exec(o) || s.exec(o) || n.exec(o) || 0 > o.indexOf('compatible') && r.exec(o) || [
      'unknow',
      '0'
    ];
  ...
  rt.prototype.Base64 = {
    ...
    _utf8_decode: function (e) {
      for (var t = '', s = 0, n = c1 = c2 = 0; e.length > s; ) n = e.charCodeAt(s),
